...
//   const handleRelatedProduct = (id : string) => {
//     setProductId(id);
//   };
              ...
              <div className="py-5 border-b">
                <div className="flex items-center gap-x-2">
                  ...
                  {/* <p className="flex text-xs md:text-base lg:text-lg items-center line-through text-slate-400 font-medium">
                    ...
                    <span>{product.mainPrice * quantity}</span>
                  </p> */}
                  {/* <span className="text-xs md:text-sm lg:text-2xl text-red-500 font-semibold ml-2">
                    {Math.round(
                      ((product.mainPrice - product.discountPrice) * 100) /
                        product.mainPrice
                    )}{" "}
                    %off
                  </span> */}
                ...
                {relatedProduct.map((product) => (
                  <SwiperSlide className="px-2" key={product._id}>
                    <div
                      ...
                      className="shadow-2xl p-2 h-[280px] cursor-pointer rounded-lg my-5"
                    >
                      <div className=" border mx-auto rounded-xl">
                        <img
                          id="product-details-fb-pixel"
                          className=" mx-auto rounded-md w-full h-[220px]"
                          src={product.image[0]}
                          alt=""
                        />
                      </div>
                      <p
                        id="product-details-fb-pixel"
                        className=" my-4 text-xl md:text-base lg:text-base font-semibold text-wrap"
                      >
              ...
              >
                {relatedProduct.map((product) => (
                  <SwiperSlide className="px-2" key={product._id}>
                    <div
                      onClick={() => handleRelatedProduct(product._id)}
                      className="shadow-xl cursor-pointer p-2 h-[270px] rounded-lg my-5"
                    >
                      <div className=" border my-2 rounded-xl">
                        <img
                          className=" mx-auto rounded-xl w-full h-[200px]"
                          src={product.image[0]}
                          alt=""
                        />
                      </div>
                      <p className=" my-4 text-sm md:text-base lg:text-base font-semibold text-wrap">
            ...
            <div className=" lg:hidden md:hidden block">
              ...
              >
                {relatedProduct.map((product) => (
                  <SwiperSlide className="px-2" key={product._id}>
                    <div
                      className="shadow-xl cursor-pointer p-2 rounded-lg my-5"
                      onClick={() => handleRelatedProduct(product._id)}
                    >
                      <div className=" border my-2 rounded-xl">
                        <img
                          className=" mx-auto rounded-xl w-full h-[170px]"
                          src={product.image[0]}
                          alt=""
                        />
                      </div>
                      <p className=" my-2 text-sm md:text-base lg:text-base font-semibold text-wrap">
